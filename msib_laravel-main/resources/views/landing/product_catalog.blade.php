    ...
    <div class="mx-lg-5 mt-lg-4 mb-lg-3">
        <div class="rounded bg-info pt-3 pb-3">
            <h2 class="text-center fw-bold mt-2">PRODUCTS</h2>
                                <!-- Tombol "Tambahkan Product" -->
    <div class="container mt-3">
        <div class="row justify-content-center">
            <a href="{{ route('get_form') }}" class="btn btn-success">Tambahkan Product</a>
        </div>
    </div>
                        ...
                        <div class="col-3">
                            <div class="card bg-white w-100">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between my-2">
                                        ...
                                        @if ($product['kondisi'] == 'Baru')
                                            <p class="my-auto rounded py-1 bg-success px-2 fw-semibold"
                                                style="font-size: 16px">{{ $product['kondisi'] }}
                                            </p>
                                        @else
                                    ...
                                    <div class="d-flex justify-content-between my-2">
                                        <p class="my-auto rounded py-1 bg-success px-2 fw-semibold"
                                            style="font-size: 16px">{{ $product['stok'] }}
                                        </p>
